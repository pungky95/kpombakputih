            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="{{ url('/kategori/create') }}" class="btn btn-primary btn-xs" title="Add New Kategori"><span class="glyphicon glyphicon-plus" aria-hidden="true"/></a>
                        <br/>
                        <br/>
                            ...
                            <table class="table table-borderless">
                                ...
                                @foreach($kategori as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->nama }}</td>
                                        <td>
                                            <a href="{{ url('/kategori/' . $item->id) }}" class="btn btn-success btn-xs" title="View Kategori"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"/></a>
